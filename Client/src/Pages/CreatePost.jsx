  ...
  return (
    ...
    >
      <motion.h1
        variants={fadeUp}
        custom={0}
        className="text-3xl md:text-4xl mb-8 font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-pink-400 dark:from-blue-300 dark:via-purple-300 dark:to-pink-300"
      >
        Create Post
      </motion.h1>
      <motion.form
